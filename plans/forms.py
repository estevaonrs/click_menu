...
class PagamentoForm(forms.Form):
    ...
    numero_cartao = forms.CharField(label='Número do Cartão de Crédito', initial='5162306219378829')
    ...
    email = forms.EmailField(label='Email', initial='marcelo.almeida@gmail.com')
